...
//
// ข้อ 3 ตัดสินใจแล้ว (2026-09-18): ข้อความในกรอบไม่ใช่สถานะระบบ — เป็นตัวอย่างที่เจ้าหน้าที่
// บันทึกตอบกลับในเรื่อง (ช่องบันทึกจากเจ้าหน้าที่) ไม่ต้องเพิ่มสถานะใน lib/tasks/status.js
...
export const CONSENT_INTRO = {
  ...
  body: "เอกสารนี้อธิบายขอบเขตการให้บริการของช่องทางดิจิทัล ข้อยกเว้น และการแจ้งผลการตรวจสอบ โปรดอ่านโดยละเอียดก่อนเริ่มใช้งาน",
};
...
export const CONSENT_SECTIONS = [
  ...
  {
    n: 3,
    title: "เงื่อนไขการประมวลผลและการแจ้งผลการตรวจสอบ",
    paragraphs: [
      [{ t: "การรับเรื่องผ่านระบบดิจิทัลจะตรวจสอบและประมวลผลตามลำดับความเร่งด่วนในวันและเวลาราชการ" }],
      [
        {
          t: "กรณีเจ้าหน้าที่เข้าตรวจสอบพื้นที่แล้วไม่พบเหตุ ณ ขณะเข้าดำเนินการ (เนื่องจากเหตุสิ้นสุดลงก่อนเจ้าหน้าที่เข้าถึง) หรือเป็นเรื่องที่ไม่อยู่ในขอบเขตตามข้อ 2 เจ้าหน้าที่จะบันทึกผลการตรวจสอบตอบกลับไว้ในเรื่องของท่าน เช่น",
        },
      ],
    ],
    statusChips: ["ตรวจสอบแล้วไม่พบเหตุ ณ เวลาปฏิบัติการ", "บันทึกข้อมูลเพื่อเฝ้าระวัง"],
    tailParagraph: [
      { t: "และเก็บข้อมูลไว้ใช้เป็นสถิติในการเฝ้าระวังต่อไป การตอบกลับดังกล่าวเป็นการแจ้งผลการดำเนินการ " },
...
- ข้อ 3 ของข้อตกลง: "ตรวจสอบแล้วไม่พบเหตุ ณ เวลาปฏิบัติการ" / "บันทึกข้อมูลเพื่อเฝ้าระวัง"
  **ไม่ใช่สถานะระบบ** (เจ้าของตัดสินใจ 2026-09-18) — เป็นตัวอย่างข้อความที่เจ้าหน้าที่บันทึก
  ตอบกลับในช่องบันทึกจากเจ้าหน้าที่ ไม่ต้องเพิ่มสถานะใน `lib/tasks/status.js`
