...
area → sqm     (ไร่×400 + งาน×100 + วา + เศษ/100) × 4
                 // เศษ = ส่วนร้อยของ ตร.ว. — ยืนยันกับ LTAX แล้ว (2026-06-29):
                 // "2 ตร.ว. เศษ 9" = 2.09 ตร.ว. → /100 (เดิมเคยเดา /10 = ผิด, แก้แล้ว)
...
- ✅ **หน่วย `เศษ`** — ยืนยันแล้ว (2026-06-29) = ส่วนร้อยของ ตร.ว. (`/100`); `parseArea` แก้จาก `/10` เป็น `/100` แล้ว
