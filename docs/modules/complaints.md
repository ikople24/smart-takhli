...
- ข้อ 3 ของข้อตกลง: **"ตรวจสอบแล้วไม่พบเหตุ ณ เวลาปฏิบัติการ"** /
  **"บันทึกข้อมูลเพื่อเฝ้าระวัง"** **ไม่ใช่สถานะระบบ** (เจ้าของตัดสินใจ 2026-09-18) —
  ข้อความข้อตกลงเขียนเป็น "เจ้าหน้าที่จะบันทึกผลการตรวจสอบตอบกลับ" คือคอมเมนต์ใน
  ช่องบันทึกจากเจ้าหน้าที่ (note/solution ของ assignment) เท่านั้น **ไม่ต้องเพิ่มสถานะใหม่**
  ใน `lib/tasks/status.js`
