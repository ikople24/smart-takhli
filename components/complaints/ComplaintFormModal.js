...
useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // เพิ่มเพื่อน LINE OA + สอนวิธีรับแจ้งเตือนสถานะอัตโนมัติ (พิมพ์ "สถานะ <เลขเรื่อง>" เพื่อผูก LINE กับเรื่อง)
      let lineHtml = '';
      if (lineOaUrl) {
        lineHtml = `
          <p style="margin:12px 0 4px;font-size:14px;color:#555">รับแจ้งเตือนความคืบหน้าอัตโนมัติทาง LINE:<br/>1) กดเพิ่มเพื่อนด้านล่าง<br/>2) พิมพ์ <strong>สถานะ ${complaintId}</strong> ในแชท</p>
