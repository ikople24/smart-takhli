...
// ด่วน → ค้างเกินเกณฑ์ → อายุมากก่อน → คงลำดับเดิม
 ...
 * @param {{ officerDepartment?: string | null, settings?: object }} [opts]
 */
export function groupPool(items, groupBy = "organization", { officerDepartment = null, settings = DEFAULT_TASK_SETTINGS } = {}) {
