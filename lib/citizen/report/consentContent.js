...
//
// ข้อ 3 ตัดสินใจแล้ว (2026-09-18): "ตรวจสอบแล้วไม่พบเหตุฯ" / "บันทึกข้อมูลเพื่อเฝ้าระวัง"
// ไม่ใช่สถานะระบบ — เป็นตัวอย่างข้อความที่เจ้าหน้าที่บันทึกตอบกลับในเรื่อง (ช่องบันทึกจากเจ้าหน้าที่)
// จึงไม่ต้องเพิ่มสถานะใหม่ใน lib/tasks/status.js
...
export const CONSENT_SECTIONS = [
  ...
  },
  {
    ...
    // ตัวอย่างข้อความตอบกลับของเจ้าหน้าที่ — ไม่ใช่สถานะระบบ
...
export const CONSENT_UPDATED_LABEL = `ปรับปรุงล่าสุด 18 กันยายน 2569 · ฉบับที่ ${CONSENT_VERSION}`;
...
export const CONSENT_FOOTER_NOTE =
  "ระบบจะบันทึกวันและเวลาที่ท่านกดยอมรับ เพื่อเป็นหลักฐานการรับทราบข้อตกลงฉบับนี้";
