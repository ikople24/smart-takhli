...
describe('emptyGroupTotals', () => {
  it('เริ่มต้นทุกกลุ่มเป็น 0 ครบ 9 กลุ่ม', () => {
    const totals = emptyGroupTotals();
    expect(Object.keys(totals)).toHaveLength(9);
